...
from tenserflow.keras.layer import Dense, Activation , Dropout
from tenserflow.optimizers import SGD
...
for document in documents:
    ...
    for word in words:
        bag.append(1) if word in word_patternselse bag.append(0)
